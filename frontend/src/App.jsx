  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Addusers" element={(role === 'superadmin' || role === 'admin') ? <AddEmployee /> : <Navigate to='/home' replace />} />
        <Route path="/ManageUsers" element={(role === 'superadmin' || role === 'admin') ? <ManageUsers /> : <Navigate to='/home' replace />} /> {/* เพิ่มบรรทัดนี้ */}
      </Routes>
    </BrowserRouter>
  );
}
